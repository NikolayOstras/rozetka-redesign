(() => {
  ...
  var require_boxicons = __commonJS({
    "node_modules/boxicons/dist/boxicons.js"(exports, module) {
      !function(t, e, n, r, o) {
        ...
        var t, e;
        t = window, e = /* @__PURE__ */ __name(function() {
          return function(t2) {
            var e2 = {};
            function n(r) {
              if (e2[r])
            ...
            }), p = window, b = {}, y = document.createElement("template"), h = /* @__PURE__ */ __name(function() {
              return !!p.ShadyCSS;
            }, "h");
        ...
        }, "e"), "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.BoxIconElement = e() : t.BoxIconElement = e();
      });
    }
  });

  // src/app.js
  var import_boxicons = __toESM(require_boxicons(), 1);
  ...
  function initInterceptors2(data2) {
    let isObject22 = /* @__PURE__ */ __name((val) => typeof val === "object" && !Array.isArray(val) && val !== null, "isObject2");
  ...
  __name(initInterceptors2, "initInterceptors2");
...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  function setClassesFromString(el, classString) {
    ...
    let addClassesAndReturnUndo = /* @__PURE__ */ __name((classes2) => {
  ...
  window.Element.prototype._x_toggleAndCascadeWithTransitions = function(el, value, show, hide) {
    ...
    let clickAwayCompatibleShow = /* @__PURE__ */ __name(() => nextTick22(show), "clickAwayCompatibleShow");
    if (value) {
  ...
  function loop(el, iteratorNames, evaluateItems, evaluateKey) {
    let isObject22 = /* @__PURE__ */ __name((i) => typeof i === "object" && !Array.isArray(i), "isObject2");
    let templateEl = el;
    evaluateItems((items) => {
  ...
  function updateSlides() {
    ...
    __name(getDirectionLabel, "getDirectionLabel");
  ...
  var processLazyPreloader = /* @__PURE__ */ __name((swiper, imageEl) => {
  ...
  var unlazy = /* @__PURE__ */ __name((swiper, index) => {
  ...
  var preload = /* @__PURE__ */ __name((swiper) => {
    if (!swiper || swiper.destroyed || !swiper.params)
      return;
    ...
    if (speed === 0) {
      ...
      if (!swiper.animating) {
        ...
        if (!swiper.onTranslateToWrapperTransitionEnd) {
          swiper.onTranslateToWrapperTransitionEnd = /* @__PURE__ */ __name(function transitionEnd2(e) {
  ...
  function slideTo(index, speed, runCallbacks, internal, initial) {
    ...
    if (speed === 0) {
      ...
      if (!swiper.onSlideToWrapperTransitionEnd) {
        swiper.onSlideToWrapperTransitionEnd = /* @__PURE__ */ __name(function transitionEnd2(e) {
          if (!swiper || swiper.destroyed)
            return;
          if (e.target !== this)
            return;
  ...
  __name(dummyEventListener, "dummyEventListener");
  var events = /* @__PURE__ */ __name((swiper, method) => {
    const document2 = getDocument();
    const {
      params,
      el,
  ...
  var isGridEnabled = /* @__PURE__ */ __name((swiper, params) => {
  ...
  // src/app.js
  module_default.data("langDropdown", () => langDropdown);
